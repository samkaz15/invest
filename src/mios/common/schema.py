...
* :class:`MiosModel` — mutable working object (config, in-flight state).
* :class:`MiosRecord` — immutable record. Anything persisted to an
...
class MiosModel(BaseModel):
    """Base for mutable models."""

    model_config = ConfigDict(extra="forbid", str_strip_whitespace=True)


class MiosRecord(BaseModel):
